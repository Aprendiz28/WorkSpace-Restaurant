...
<head>
    ...
    <link rel="icon" href="#">
    <title>Inicio || Sistema de pedidos de alimentos en línea - Code Camp BD</title>
    ...
    <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Entrega de pedidos y comida para llevar </h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Ordenar comida</h4>
                    </div>
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Entrega o para llevar</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Platos populares del mes</h2>
                <p class="lead">La forma más fácil de pedir tu comida favorita entre estos 6 platos principales</p>
            </div>
            <div class="row">
