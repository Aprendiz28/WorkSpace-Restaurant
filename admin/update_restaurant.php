                            ...
                            <div class="dropdown-menu animated zoomIn">
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i>Este es otro enlace</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i>Este es otro enlacek</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i>Este es otro enlace</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i>Este es otro enlace</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i>Este es otro enlace</a></li>
                                        </ul>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_restaurant.php">Agregar restaurantet</a></li>
                            </ul>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        <h4 class="m-b-0 ">Actualizar Restaurante</h4>
                        <div class="card-body">
