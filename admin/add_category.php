                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="add_category.php">Añadir categoria</a></li>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white">Agregar categoría de restaurante</h4>
                                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Categorías listadas</h4>
