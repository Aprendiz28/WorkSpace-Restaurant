                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            title="Update order">
                                                            <button type="button" class="btn btn-primary">Actualizar estado del pedido</button></a>
                                                    </center>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            title="Update order">
                                                            <button type="button" class="btn btn-primary">Ver detalles del usuario</button></a>
                                                    </center>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                if ($status == "rejected") {
                                                    ...
                                                    <td>
                                                        <center><button type="button" class="btn btn-danger"> <i
                                                                    class="fa fa-close"></i> Cancelado</button> </center>
                                                    </td>
                                                <?php
                                                }
                                                ?>
